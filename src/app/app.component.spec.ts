...
describe('AppComponent', () => {
  ...
  it('should emit the searchPosProduct value', () => {
    ...
    component.foundVariant = [{ id: 1, sku: 'P', name: 'Cake', isActive: true }]

    expect(component.foundVariant).toEqual([{ id: 1, sku: 'P', name: 'Cake', isActive: true }])
  })
  ...
  it('should emit the allVariant value', () => {
    component.variants = [{ id: 1, sku: 'P', name: 'Cake', isActive: true }]

    expect(component.variants).toEqual([{ id: 1, sku: 'P', name: 'Cake', isActive: true }])
  })
})
